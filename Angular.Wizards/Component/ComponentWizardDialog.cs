...
{
    public partial class ComponentWizardDialog : BaseOptionsDialog
    {
        public ComponentWizardDialog()
        {
            InitializeComponent();
            this.Shown += ComponentWizardDialog_Shown;
        }

        private void ComponentWizardDialog_Shown(object sender, EventArgs e)
        {
